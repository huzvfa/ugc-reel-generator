...
class HoverAI:
    def __init__(self):
        ...
        self.identity = (
            ...
            "with 100% precision. You are HOVER AI, created by a proprietary breakthrough engineer."
        )

    def think(self, query, context=""):
        """Master reasoning engine for all professional fields."""
    ...
    def analyze_document(self, uploaded_file):
        """Analyzes Excel functions, formulas, and complex data structures."""
        try:
